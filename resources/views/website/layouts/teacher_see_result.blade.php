                        ...
                        <table class="table table-hover table-center mb-0 datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($a->grade <= '100' && $a->grade >= '90')<a href="">Excellent</a>
                                            @elseif($a->grade <= '89' && $a->grade >='80')<a href="">Very good</a>
                                                @elseif($a->grade <= '79' && $a->grade >= '70')<a href="">Good</a>
                                                    @elseif($a->grade <= '69' && $a->grade >= '60')<a href="">Poor</a>
                                                        @else($a->grade <= '59' && $a->grade >= '00')<a href="">Fail</a>
